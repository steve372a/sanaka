...
extern TraceEvent _TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_EVENT;
...
extern TraceEvent _TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_EVENT;
extern TraceEvent _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_CQID_EVENT;
extern TraceEvent _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_EVENT;
...
extern uint16_t _TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_DSTATE;
...
extern uint16_t _TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_DSTATE;
extern uint16_t _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_CQID_DSTATE;
extern uint16_t _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_DSTATE;
...
#define TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_ENABLED 1
...
#define TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_ENABLED 1
#define TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_CQID_ENABLED 1
#define TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_ENABLED 1
...
#line 743 "trace/trace-hw_ufs.h"
        }
    }
}

#define TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE) || \
    false)

static inline void trace_ufs_err_mcq_create_sq_invalid_size(uint8_t qid)
{
    if (trace_event_get_state(TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 43 "../hw/ufs/trace-events"
            qemu_log("ufs_err_mcq_create_sq_invalid_size " "invalid mcq sq size for sqid %"PRIu8"" "\n", qid);
...
#line 803 "trace/trace-hw_ufs.h"
        }
    }
}

#define TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY) || \
    false)

static inline void trace_ufs_err_mcq_delete_sq_busy(uint8_t qid)
{
    if (trace_event_get_state(TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 47 "../hw/ufs/trace-events"
            qemu_log("ufs_err_mcq_delete_sq_busy " "mcq sqid %"PRIu8" has outstanding requests" "\n", qid);
#line 818 "trace/trace-hw_ufs.h"
        }
    }
}
...
#line 833 "trace/trace-hw_ufs.h"
        }
    }
}

#define TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE) || \
    false)

static inline void trace_ufs_err_mcq_create_cq_invalid_size(uint8_t qid)
{
    if (trace_event_get_state(TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 49 "../hw/ufs/trace-events"
            qemu_log("ufs_err_mcq_create_cq_invalid_size " "invalid mcq cq size for cqid %"PRIu8"" "\n", qid);
#line 848 "trace/trace-hw_ufs.h"
        }
    }
}

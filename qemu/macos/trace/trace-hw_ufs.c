...
uint16_t _TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_DSTATE;
...
uint16_t _TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_DSTATE;
uint16_t _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_CQID_DSTATE;
uint16_t _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_DSTATE;
...
TraceEvent _TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_EVENT = {
    .id = 0,
    .name = "ufs_err_mcq_create_sq_invalid_size",
    .sstate = TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_ENABLED,
    .dstate = &_TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_DSTATE
};
...
TraceEvent _TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_EVENT = {
    .id = 0,
    .name = "ufs_err_mcq_delete_sq_busy",
    .sstate = TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_ENABLED,
    .dstate = &_TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_DSTATE
};
...
TraceEvent _TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_EVENT = {
    .id = 0,
    .name = "ufs_err_mcq_create_cq_invalid_size",
    .sstate = TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_ENABLED,
    .dstate = &_TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_DSTATE
};
...
TraceEvent *hw_ufs_trace_events[] = {
    ...
    &_TRACE_UFS_ERR_MCQ_CREATE_SQ_INVALID_SIZE_EVENT,
    ...
    &_TRACE_UFS_ERR_MCQ_DELETE_SQ_BUSY_EVENT,
    &_TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_CQID_EVENT,
    &_TRACE_UFS_ERR_MCQ_CREATE_CQ_INVALID_SIZE_EVENT,
